...
"""
# Creates a 4x4 of the same image

# OR
"""img1 = cv2.imread("images/cards.jpg")
img2 = cv2.imread("images/instagram.png")
img_ver2 = np.vstack((img1, img2))
cv2.imshow("Vertical", img_ver2)"""
# But they hae to be on the same sign
